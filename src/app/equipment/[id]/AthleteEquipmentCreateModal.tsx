...
export default function AthleteEquipmentCreateModal({
  athleteId,
  athleteName,
}: Props) {
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs font-bold text-slate-400">
                    Equipo ligado a:{" "}
                    <span className="text-cyan-300">{athleteName}</span>
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <section className={sectionClass}>
                ...
                <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
                  <div className="flex h-11 items-center gap-2 rounded-xl border border-cyan-400/10 bg-slate-950/70 px-3 text-xs font-black text-cyan-300">
                    <User size={14} />
